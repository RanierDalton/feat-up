...
('Celo', 'Celo', 'Urubu#100', 'celo.beats@example.com', 'Produtor focado em criar beats autênticos para o trap, misturando elementos melódicos e pesados.', 'Beat', 'FL Studio', '../static/assets/profiles/celo.jpeg'),
